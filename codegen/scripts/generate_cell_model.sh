...
#
# Generate the source and header files for a new CellModel from M4 templates.
#
# Usage:
#
...
echo
info "Remember to register CellModel_${NAME} in the CellModel factory if"
